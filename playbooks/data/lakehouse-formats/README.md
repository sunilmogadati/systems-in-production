# Lakehouse Formats Playbook

**Delta Lake, Apache Iceberg, and Apache Hudi — ACID transactions on files. How modern table formats turn a data lake into a lakehouse.**
