...
| **Want to build data pipelines** | [SQL Playbook ch 01](playbooks/data/data-design/sql/01_Why.md) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sunilmogadati/systems-in-production/blob/main/implementation/notebooks/Advanced_SQL.ipynb) Query real data in minutes |
...
a production diagnostic system (CSI) — continuously observe, diagnose, and improve production systems across code, data, product, and business. Full architecture with Mermaid diagrams.
